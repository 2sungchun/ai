...
public class Tool {
  ...
  public static String getSMSToken() throws IOException { 
    ...
    String apiKey = "2eef19169d93883e19b8c274ed7b3416"; // SMS 관리툴에서 발급받은 API KEY 를 입력해 주세요.
    String authValue = Base64.getEncoder()
        .encodeToString(String.format("%s:%s", smsId, apiKey).getBytes(StandardCharsets.UTF_8)); // Authorization Header
                                                                                                 // 에 입력할 값입니다.
