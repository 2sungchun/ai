...
public class MMS {
  ...
  public static void main(String[] args) throws IOException {
    String smsId = "sunghun1103sms"; // SMS ID 를 입력해 주세요.
    ...
    RequestBody requestBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
        .addFormDataPart("phone", "01043202269") // 수신번호를 입력해 주세요. (수신번호가 두 개 이상인 경우 ',' 를 이용하여 입력합니다. ex)
                                                          // 01011112222,01033334444)
        .addFormDataPart("callback", "01043202269") // 발신번호를 입력해 주세요.
        ...
        .addFormDataPart("images0", "summer02.jpg", RequestBody.create(new File("C:\\kd\\deploy\\mms\\storage\\summer02.jpg"), MultipartBody.FORM)) // 이미지
